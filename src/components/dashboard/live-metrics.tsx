    ...
    const platforms = [
        {
            ...
            organicMetrics: [
                ...
                { label: metaData?.organicMetrics?.ig_connected ? (isRtl ? "متابعي انستجرام" : "IG Followers") : (isRtl ? "غير مربوط بانستجرام" : "IG Not Connected"), value: metaData?.organicMetrics?.ig_followers?.toLocaleString() || '0', color: "text-rose-400", icon: <Instagram className="w-4 h-4" /> },
