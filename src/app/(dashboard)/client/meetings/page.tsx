...
export const metadata: Metadata = {
    title: "Meeting Requests | MilaKnight",
};
    ...
    return (
        <div className="p-4 md:p-8 space-y-8 max-w-7xl mx-auto">
            <div className="flex flex-col gap-2">
                ...
                <p className="text-muted-foreground font-medium">Track and manage your scheduled meeting requests.</p>
            </div>

            <MeetingRequestsUI requests={requests} userRole={session?.user?.role || "CLIENT"} />
        </div>
    );
}
